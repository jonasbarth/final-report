...
All experiments were run once on a Google Cloud 4CPU 15GB RAM virtual machine. 
...
Choosing the hyperparameters for a model is an important aspect. 
...
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/dqn_results_1.png}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/dqn_results_2.png}
\endminipage\hfill
\minipage{0.33\textwidth}%
  \includegraphics[width=\linewidth]{figs/dqn_results_3.png}
\endminipage
...
\begin{tabular}{ |c|c|c|c|c|c| } 
	\hline
	\textbf{Levels} & Steps & Pipe with Progressive & Pipe & Steps + Pipe & Steps + Pipe with Progressive \\
	\hline
	\textbf{Total Rewards} & 388.12 & 2485.56 & 4483.92 & -228.09 & 388.12 \\
	\hline
\end{tabular}
\caption{The total sum of credits accumulated in each level by the DQN agent.}
\end{table}
...
\begin{figure}[!htb]
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/oc_results_1.png}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/oc_results_2.png}
\endminipage\hfill
\minipage{0.33\textwidth}%
  \includegraphics[width=\linewidth]{figs/oc_results_3.png}
\endminipage
...
\begin{figure}[!htb]
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/fun_results_1.png}
\endminipage\hfill
\minipage{0.33\textwidth}
  \includegraphics[width=\linewidth]{figs/fun_results_2.png}
\endminipage\hfill
\minipage{0.33\textwidth}%
  \includegraphics[width=\linewidth]{figs/fun_results_3.png}
\endminipage
